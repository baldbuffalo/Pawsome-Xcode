...
{
    [Fact] public void String_RoundTrips()
    {
    ...
    [Fact] public void Integer_SerializesAsString_AndParsesBack()
    {
    ...
    [Fact] public void Bool_RoundTrips()
    {
    ...
    [Fact] public void Null_RoundTripsAsNullValue()
    {
    ...
    [Fact] public void Timestamp_RoundTrips_AsUtc()
    {
    ...
    [Fact] public void StringArray_RoundTrips()
    {
    ...
    [Fact] public void ParseFields_ReadsAndroidPostDocument()
    {
    ...
    [Fact] public void ToFields_ProducesValidShapeForCreate()
    {
    ...
    [Fact] public void Post_FromFirestore_ReturnsNull_WhenRequiredFieldsMissing()
    {
...
{
    [Fact] public void JustNow_ForRecentTimes() => Assert.Equal("just now", DateTimeOffset.UtcNow.TimeAgoDisplay());
    [Fact] public void Hours_Ago() => Assert.Equal("2h ago", DateTimeOffset.UtcNow.AddHours(-2).TimeAgoDisplay());
    [Fact] public void Days_Ago() => Assert.Equal("3d ago", DateTimeOffset.UtcNow.AddDays(-3).TimeAgoDisplay());
}
